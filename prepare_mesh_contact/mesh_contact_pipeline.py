...
def main() -> None:
    ...
    if source_t_len == 0:
        ...
        v1 = np.zeros((0, 0, 3), dtype=np.float32)
        v2 = np.zeros((0, 0, 3), dtype=np.float32)
        if not args.quiet:
